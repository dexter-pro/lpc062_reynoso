# Realizado por: Angel Ivan Reynoso Perez :: Grupo 062
...
$array = $Object
$array | Export-Csv -Path D:\FCFM\3ro\laboratorio_ciberprog\ev_15\test.csv -NoTypeInformation # Aqui se genera archivo csv
#
#### Para Envio de correo
#
$Username = "angel10.reynoso.ar@gmail.com"; # Aqui va tu cuenta de gmail
$Password = "shqfmacogbhgcttj";      # Aqui va tu password de aplicación
$path = "D:\FCFM\3ro\laboratorio_ciberprog\ev_15\test.csv";       # Aqui va la ruta de el archivo csv generado previamente
function Send-ToEmail([string]$email, [string]$attachmentpath){
    $message = new-object Net.Mail.MailMessage;
    $message.From = "angel10.reynoso.ar@gmail.com"; # Aqui va tu cuenta de gmail.
    $message.To.Add($email);
    $message.Subject = "INFO DE " + $name; #Asunto del correo
...
Send-ToEmail  -email "reynoso_angel@outlook.fr" -attachmentpath $path; # En email pones el destinatario